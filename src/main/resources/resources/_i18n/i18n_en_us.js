...
value('common', {
	...
	_INACTIVE:'Inativo',
	_INCLUDE:'Incluir',
	_INCLUDED:'Incluído em ',
	_ISSUED:'Emissão',
	_ISSUE_DATE:'Data de início',
    ...
    _ORDER_PREVIOUS:'Antes',
    _ORDER_TODAY:'Hoje',
    _ORDER_NEXT:'Depois',

    _OWNER:'Criado por',

    _REVIEW:'Monitoramento',
    ...
    _REVIEW_TYPE: 'Tipo',
    _REVIEW_TYPE_REVIEW: 'Monitoramento',
    _REVIEW_TYPE_CONCLUSION: 'Conclusão',
    _REVIEW_TYPE_RESTART: 'Reabertura',
    _REVIEW_TYPE_CANCEL: 'Cancelamento',

    _VERSION_TO_PRINT: 'Versão para impressão',
	...
	IDENTITY_ALTERNATE_EMAIL:'E-mail alternativo',
    ...
    IDENTITY_NOTIFICATION : 'Notificar no',
    IDENTITY_NOTIFICATION_PRINCIPAL:' email principal',
    IDENTITY_NOTIFICATION_EMAIL:' email alternativo',
    IDENTITY_NOTIFICATION_BY_REQUEST:'email',
