...
<body id="app" 
	data-ng-controller="${baseName?capitalize}Controller as $main"
	...
	<!--
	 ! Modal mostrado quando o modelo exibe modalAlert.
	 !-->
	<div class="modal fade" id="modalAlert" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
